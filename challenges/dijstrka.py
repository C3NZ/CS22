...
def process_args():
    """
        Process the arguments for dijstrika's shortest path
    """
    parser = argparse.ArgumentParser(
        description="Find the shortest weighted path between two verticies"
    )
    parser.add_argument(
...
def main(args: argparse.Namespace):
    """
        Check for the shortest weighted path between two vertices
    ...
    path = graph.find_min_weight(args.from_vert, args.to_vert)
